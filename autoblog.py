...
def generate_blog_post(news_context):
    ...
    try:
        ...
        # UPGRADE 5.0: The Asset Manager (Downloading the image permanently)
        ...
        # Python downloads the image and saves it locally
        urllib.request.urlretrieve(image_url, image_filepath)
        
        # We tell the blog to look for the downloaded image on your actual website
...
def save_post(content):
    ...
    print(f"✅ Success! V5 File saved to {filename}")
